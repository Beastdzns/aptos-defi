  ...
  return (
    <div className="py-2">
          ...
          <div className="py-2 flex gap-2 flex-wrap">
            {ram.map((ele, idx) => {
              return (
                <Button
                  className={twMerge(
                    selectedRAM === idx ? "bg-blue-300 text-black" : "",
                    " generalTabsBorder"
                  )}
                  onClick={() => {
                    setSelectedRAM(idx);
          ...
          <div className="py-2 flex gap-2 flex-wrap">
            {cores.map((ele, idx) => {
              return (
                <Button
                  className={twMerge(
                    selectedCore === idx ? "bg-pink-300 text-black" : "",
                    "  generalTabsBorder"
                  )}
                  onClick={() => {
                    setSelectedCore(idx);
      ...
      <div className="flex flex-col gap-4">
        <h2 className="text-3xl ">Expected costs</h2>
        <div className="flex flex-col gap-2 bg-yellow-300 w-fit rounded-2xl p-4">
          <h3 className="text-2xl ">
            {returnPrice(selectedCore, selectedRAM)[0]}USD /hr
          </h3>
          <h3 className="text-2xl font-bold">or</h3>
          <h3 className="text-2xl font-bold">
            {returnPrice(selectedCore, selectedRAM)[1]}USD /hr
          </h3>
        </div>
      </div>
    </div>
